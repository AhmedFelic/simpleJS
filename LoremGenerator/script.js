...
const result = document.querySelector('.lorem-text');   //kad koristis query ide .className inace ces debagovati 3h


form.addEventListener("submit", function (e) {
    e.preventDefault();

    const value = parseInt(amount.value); //bez parseInt daje broj u stringu
    const random = Math.floor(Math.random() * text.length)


    //nista uneseno, manje od 0, vise od 9 ; ili ispravno
